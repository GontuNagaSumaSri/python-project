    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creationdate', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pjmapp.job')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('eventinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pjmapp.job')),
                ('userinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pjmapp.usersignup')),
            ],
        ),
    ]
